...
import SubscriptionGuard from '../../../components/subscription-guard'; // Corrected import path
...
const newQuestion = (): QuestionState => ({
    ...
    timer: 30,
    options: ['', '', '', ''],
    answer: '', // For multiple-choice, this will be the text of the correct option
});
...
export default function CreateQuizPage() {
    ...
    // Generic handler to update any field in a question's state
    const handleQuestionChange = (index: number, field: keyof QuestionState, value: any) => {
        ...
        // When changing type, reset options and answer for a clean slate
        if (field === 'type') {
    ...
    // Specific handler for updating an option in a multiple-choice question
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError("Error: Could not create quiz. Please check your connection and try again.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div className="space-y-12">
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            <h1 className="text-2xl font-semibold leading-7 text-gray-900">Create a New Quiz</h1>
                            <p className="mt-1 text-sm leading-6 text-gray-600">Fill in the details to build your engaging quiz.</p>
                            <div className="mt-6">
